...
function NuevoProductoContent() {
    ...
    const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (uploadError) {
            ...
            setError("Error subiendo la imagen. Verifica que el bucket 'product-images' existe en Supabase Storage.")
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-4">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-neutral-500">
                                        Precio único sin importar invitados
                                    </p>
                                </div>
                            </button>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-[10px] text-neutral-500">
                                        Varía según cantidad de personas
                                    </p>
                                </div>
                            </button>
                        </div>
