...
function FloatingWhatsApp() {
  return (
    <a
      href="https://wa.me/523336821088?text=Hola,%20me%20gustar%C3%ADa%20conocer%20m%C3%A1s%20sobre%20El%20Romeral"
      target="_blank"
    ...
    >
      ...
      <div className="relative w-13 h-13 flex items-center justify-center">
        ...
        <div className="relative w-13 h-13 rounded-full bg-[#25D366] shadow-lg shadow-[#25D366]/30 hover:scale-110 hover:shadow-xl hover:shadow-[#25D366]/40 transition-all duration-500 flex items-center justify-center border border-[#25D366]/20"
