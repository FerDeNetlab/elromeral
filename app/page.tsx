...
import { trackWhatsAppClick, trackFaqOpen } from "@/lib/gtm"

const WA_LINK =
  "https://wa.me/523338708159?text=Hola%2C%20me%20gustar%C3%ADa%20conocer%20m%C3%A1s%20sobre%20El%20Romeral"
...
function FloatingWhatsApp() {
  return (
    <a href={WA_LINK} target="_blank" rel="noopener noreferrer"
       aria-label="Contactar a El Romeral por WhatsApp"
      ...
      <div className="relative flex items-center justify-center" style={{ width: 52, height: 52 }}>
        ...
        <div className="relative rounded-full bg-[#25D366] shadow-lg flex items-center justify-center"
